...
from models.activations import gelu, gelu_new, swish
from models.configuration_bert import BertConfig
from models.file_utils import add_start_docstrings, add_start_docstrings_to_callable
from models.modeling_utils import PreTrainedModel, prune_linear_layer
...
class BertModelNew(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.encoder = BertEncoder(config,num=2)
